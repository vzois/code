...
#define DSKY_PSTOP_ADDR VAR_8_ADDR
#define DSKY_REMOTE_PSTOP_ADDR_2 VAR_6_ADDR
#define DSKY_REMOTE_PSTOP_ADDR_1 VAR_4_ADDR
...
#define DSKY_SKIP_TO_NEXT_PART VAR_2_ADDR
